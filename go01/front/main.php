				...
				<div style="width:100%; padding:2px; height:290px;">
					<div id="mwww" loop="true" style="width:100%; height:100%;">
						<div style="width:99%; height:100%; position:relative;" class="cent">沒有DDDDasd資料</div>
					</div>
				</div>
				<div
					...
					<span class="t botli">最新消息區<a href="?do=news">...More</a>
					</span>
					...
					?>
					<div>
						<div class="all" style="display:none;"><?=($k+1)." . ". $row['text'] ?></div>
